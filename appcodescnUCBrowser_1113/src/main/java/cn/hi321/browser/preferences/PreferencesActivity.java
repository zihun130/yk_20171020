...
public class PreferencesActivity extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.set_ysbh_layout:
			...
			Toast.makeText(PreferencesActivity.this, "棰勭暀", 0).show();
			break;
...
//				if(isFullScreen){//琛ㄧず鍏ㄥ睆
//					 UserPreference.save("fullScreen", !isFullScreen); 
//				}else{//琛ㄧず闈炲叏灞?//					 UserPreference.save("fullScreen", !isFullScreen); 
//				} 
//				return true;
//			}
//		});
//		//鏄惁闅愯棌鏍囬鏍?////		Preference hideTitleBarPref = (Preference) findPreference(Constants.PREFERENCES_GENERAL_HIDE_TITLE_BARS);
...
//	}
//	
//	/**鏄剧ず鐨勬洿鏂版棩蹇楀璇濇銆?//	 * Display the changelog dialog.
//	 */
