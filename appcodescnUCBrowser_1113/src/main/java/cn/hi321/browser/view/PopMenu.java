...
public class PopMenu {
	...
	private int viewOffset = 0;// 动画图片偏移�?	private int imgWidth;// 图片宽度
...
//		popupWindow.update();  
		...
		view.setOnKeyListener(new OnKeyListener() {  
	        ...
	        public boolean onKey(View v, int keyCode, KeyEvent event) {  
	            ...
	            if ((keyCode == KeyEvent.KEYCODE_MENU)&&(popupWindow.isShowing())) {  
	            	popupWindow.dismiss();// 这里写明模拟menu的PopupWindow�?��就行  
	                return true;  
	            }  
	            return false;  
	        }  
	...
	public class myPagerAdapter extends PagerAdapter {
		...
		public Object instantiateItem(View arg0, int arg1) {
			...
			// 将来添加菜单的时�?新建�?��gridviewadapter 然后new个gridview 添加到这里就可以
...
//								break;
							...
							case 6://是否全屏模式 
								...
								}else{//表示非全�?									 UserPreference.save("fullScreen", !isFullScreen); 
								} 
								girdViewAdapter.setFlag(0);
								girdViewAdapter.notifyDataSetChanged();
