...
public class Utils {	
	...
	public static int NUM = 0;// 表示精�?页面图片更新的数�?	
	...
	public static boolean isTipFilter = false;//是否弹出请求不到筛�?的Dialog
	public static boolean isGetData = false;//是否取到了频道页的数�?
	...
	/**
	 * 判断是否是第�?��下载 add by jiyx at 2012-9-17 11:05:15
	 * @param context
	 * @param fName
	 * @return
	 */
...
//					waitingDialog.setCanceledOnTouchOutside(false);
	...
	public static boolean  getFirstStartForceUpdateVaule(Context context) {
		 ...
		 /**
		  * 判断用户输入的内容是是否为数�?		  * 2013-5-16下午2:11:02
		  * @param str
		  * @return
		  */
	...
	public static void netNoPlayeDialog(Context context) {// �?��确认
		AlertDialog.Builder ad = new AlertDialog.Builder(context);
		ad.setTitle("提示");
		ad.setMessage("暂时只支持android_2.1以上系统");
		ad.setPositiveButton("确定", new DialogInterface.OnClickListener() {// �?��按钮
