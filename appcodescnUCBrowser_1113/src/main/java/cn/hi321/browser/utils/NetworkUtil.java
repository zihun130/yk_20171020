...
public class NetworkUtil {
    ...
    public final static int TYPE_NET_WORK_DISABLED = 0;// 缃戠粶涓嶅彲鐢?    public final static int TYPE_MNO_CM = 1;// 绉诲姩
    public final static int TYPE_MNO_CU = 2;// 鑱旈?
    public final static int TYPE_MNO_CT = 3;// 鐢典俊
    public final static int TYPE_CM_CU_WAP = 4;// 绉诲姩鑱旈?wap10.0.0.172
    public final static int TYPE_CT_WAP = 5;// 鐢典俊wap 10.0.0.200
    public final static int TYPE_OTHER_NET = 6;// 鐢典俊,绉诲姩,鑱旈?,wifi 绛塶et缃戠粶
	...
	public static boolean isWIFISTATE = false;//褰撳墠缃戠粶鐘舵?鏄惁涓篧IFI
	public static boolean is2Gor3G = false;//褰撳墠缃戠粶鐘舵?鏄惁涓?G
	...
	public final static int GET_MEDIA_COMMENT_LIST_DATA = 45;//濯掍綋绮惧僵璇勮
	public final static int GET_HOT_WORD_DATA = 46;//鑾峰彇鐑瘝鎻愮ず
	public final static int REPORT_CRASH_INFO = 47;//涓婃姤宕╂簝鏃ュ織
	public final static int CACHE_DATA_FEATURED_READ = 48;//璇诲彇绮鹃?缂撳瓨
	public final static int CACHE_DATA_FEATURED_WRITE = 49;//鍐欏叆绮鹃?缂撳瓨鏁版嵁
	...
	public final static int GET_PROGRAM_DETAIL_BY_SERVER = 55;//鑾峰彇鑺傜洰璇︽儏鏁版嵁
	public final static int GET_LIVE_TV_DATA = 56;//live related keywords
	public final static int GET_LIVE_BROADCASTS_DATA = 57;
	public final static int GET_PROGRAM_PAGE_DATA = 58;//鑾峰彇鑺傜洰椤垫暟鎹殑鏍囧織
